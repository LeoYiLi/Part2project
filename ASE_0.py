...
atoms0 = read("YBa2Cu3O7_Int1.cif")
...
#ucf = UnitCellFilter(atoms0, mask=[1,1,1,0,0,0], hydrostatic_strain=True)
ucf = UnitCellFilter(atoms0, mask=[1,1,1,0,0,0])
#Same as 123000 in castep
dyn = BFGS(ucf, logfile="-", trajectory="vc.traj")
dyn.run(fmax=0.005, steps=1000)  

write("YBa2Cu3O7_Int1_MACE.cif", atoms0)
